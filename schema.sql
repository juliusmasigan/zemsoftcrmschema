...
CREATE TABLE `permission` (
  ...
  `prepare` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `user` (
  ...
  CONSTRAINT `fk_profileid_profile` FOREIGN KEY (`id`) REFERENCES `profile` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-02-17 20:37:14
